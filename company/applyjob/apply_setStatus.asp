		...
		If rtn = "1" Then
			...
			If isArray(result2) Then
				For ii=0 to ubound(result2, 2)
														...
														"<tbody>"&_
															...
															"<tr>"&_
																"<td colspan=""2"" style=""padding:10px 20px 10px 20px;text-align:center;"">"&_
																	"<a href=""http://" & request.ServerVariables("SERVER_NAME") & "/my/job_application_list.asp"" target=""_blank"">"&_
					...
					mailer.To	= applyEmail
					mailer.Subject	= "[" & site_name & "] " & " 채용담당자가 지원한 이력서를 열람했습니다."
