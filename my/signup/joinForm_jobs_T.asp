...
'	Response.write "<script language=javascript>"&_
'		"alert('잘못된 접근입니다.');"&_
'		"location.href='./joinForm_member.asp';"&_
'		"</script>"
'	Response.End
'End If
        ...
        <div class="layoutBox">
			...
			<div id="memberPer" class="memberInfo per">
				...
				<form name="frm1" id="frm1" method="post">
					...
					<input type="hidden" id="txtPass" name="txtPass" value="<%=Request("txtPass")%>">
					<input type="hidden" id="txtEmail" name="txtEmail" value="<%=Request("txtEmail")%>">
					<input type="hidden" id="txtPhone" name="txtPhone" value="<%=Request("txtPhone")%>">
					<input type="hidden" id="chkAgrPrv" name="chkAgrPrv" value="<%=Request("chkAgrPrv")%>">

					<input type="hidden" id="juminH" name="juminH" maxlength="7" value="">		<!--주민번호뒷자리-->
					...
					<!--회원정보 입력-->
					<!--#include file="./inc_jobs_info_T.asp"-->
					
					<!--최종학력사항-->
					<!--#include file="./inc_jobs_education.asp"-->

					<!--희망취업조건-->
					<!--#include file="./inc_jobs_career_T.asp"-->
...
<!-- 희망지역 팝업 -->
<!--#include file="./pop_sch_workarea_T.asp"-->
<!-- 희망지역 팝업 -->
