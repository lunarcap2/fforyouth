...
%>	
				...
				<div class="rnb_box">
					<div class="rnb_con view">
						...
						<ul class="btn_ul">
							...
							<li><a href="javaScript:;" onclick="">MS워드로 다운로드</a><li>
		...
		<div class="content glay">
			<div class="con_area">
				...
				<div id="view1" class="view_box">
					...
					<div class="vb_item">
						<div class="vb_label">이름</div>
						<div class="vb_value"><%=p_userName%></div>
					</div>
					...
					<div class="vb_item">
						...
						<div class="vb_value"><%=p_birth%>&nbsp;(<%=p_age%>세)</div>
					</div>
	...
	<% If v_menu_file = "Y" Then %>
	<iframe src="/resume/view_print.asp?rid=<%=rid%>&set_user_id=<%=set_user_id%>" id="printUrl" border="0" cellspacing="0" width="0px" height="0px" frameborder="0"></iframe>
	<% End If %>