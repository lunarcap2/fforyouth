...
If isArray(arrComm) Then
	...
	If arrComm(19, 0) <> "" Then p_userPhoto = "/files/mypic/" & arrComm(19, 0)
End If 
...
Function getDateDiff(p_sdate, p_edate)
	...
	If isDate(sdate) And isDate(edate) Then
		out_value = Datediff("m", sdate, edate)
...
Dim print_url
print_url = Request.ServerVariables("SERVER_NAME") & "/resume/view_print.asp"

%>

<iframe src="http://newprint.career.co.kr/intra/view_test.asp?set_rid=<%=rid%>&set_userid=<%=set_user_id%>&set_url=<%=print_url%>" id="printUrl" border="0" cellspacing="0" width="0px" height="0px" frameborder="0"></iframe>
...
<div id="contents" class="sub_page">
		...
		<div class="rnb">
			<div class="rnb_box">
				<div class="rnb_con view">
					...
					<ul class="btn_ul">
						<li><a href="javaScript:;" onclick="fn_print_test('printUrl');">인쇄하기</a><li>
						<li><a href="javaScript:;">MS워드로 다운로드</a><li>
						<li><a href="javaScript:;">PDF로 다운로드</a><li>
					</ul>
					<% End If %>
	...
	<div class="content">
		<div class="con_area print">
			...
			<div id="view2" class="view_box">
				...
				<div class="vb_section">
					<div class="vb_row">
						...
						<div class="term">(<span><%=cal_sdate%></span>~<span><%=cal_edate%></span> / <%=univ_year%>)</div>
						<div class="line">
			...
			Dim military_sdate, military_syear, military_smonth, military_edate, military_eyear, military_emonth
							...
							<tr>
								...
								<td colspan="2">
									<div class="category_area area">
										...
										<div class="category">
											<div class="c_jobs"><%=getAcName(arrArea(0, i))%> > <%=getAcName(arrArea(1, i))%></div>
										</div>
										<% Next %>
									</div>
								</td>
			...
			<div class="chk_txt">
				...
				<em>
				이 이력서는 2020년 05월 25일 (월)에 최종 업데이트된 이력서 입니다.<br>
				위조된 문서를 등록하여 취업활동에 이용 시 법적 책임을 지게 될 수 있습니다.<br>
				(주)커리어넷은 구직자가 등록 한 문서에 대해 보증하거나 별도의 책임을 지지 않으며<br>
