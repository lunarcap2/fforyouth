<script type="text/javascript">
	...
	function fn_gde_chk(obj) {
		...
		if ($(obj).is(":checked")) {
			$(obj).parents('.ib_m_box').find('#univ_name').val('대입검정고시').attr('readonly', true);
	...
	function fn_school_chg_univ_kind(obj, val) {
		...
		if (val == "high") {
			...
			$(obj).parents('.ib_m_box').find('#univ_name').val("고등학교 이하");
	...
	<div class="ib_list add1">
		...
		<div class="ib_move">
			...
			<div class="ib_m_box">
				...
				<input type="hidden" id="univ_pointavg" name="univ_pointavg" value="<%=arrSchool(14, i)%>"> <!-- 학점기준(X) -->
				...
				<input type="hidden" id="gde" name="gde" value="<%=arrSchool(21,i)%>"> <!-- 검정고시 -->
				...
				<div class="select_down" style="width:290px;" title="학력구분">
					...
					<div class="sel">
						<ul id="ul_sel_univ_kind" style="display: none;">
							<li><a href="javaScript:;" onclick="fn_sel_value_set(this, 'univ_kind', '2'); fn_school_chg_univ_kind(this, 'below');">고등학교 이하</a></li>
				...
				<div class="search_box" style="width:433px;" id="div_search_box">
					...
					<div class="result_box" id="id_result_box"><!-- 자동완성 영역 -->
					<!--
						<ul class="rb_ul">
							<li>
				...
				<label class="checkbox off" id="lb_chk_gde"><input type="checkbox" class="chk" value="1" id="chk_gde" onclick="fn_gde_chk(this)"><span>대입 검정고시</span></label>
				...
				<br>
				<div class="select_down" id="div_univ_etype" style="width:290px;<%=univ_visible%>" title="졸업상태">
				...
				<input type="text" id="div_univ_sdate" name="univ_sdate" class="txt" placeholder="입학년월 (ex. 2019.03)" value="<%=univ_sdate%>" onkeyup="numCheck(this, 'int'); changeDateType(this); fn_school_s_div(this);" onblur="chkDateType(this)" maxlength="6" style="width:290px;<%=univ_visible%>">
				<input type="text" id="div_univ_edate" name="univ_edate" class="txt" placeholder="졸업년월 (ex. 2020.02)" value="<%=univ_edate%>" onkeyup="numCheck(this, 'int'); changeDateType(this); fn_school_e_div(this);" onblur="chkDateType(this)" maxlength="6" style="width:290px;">
		...
		<div class="ib_move">
			...
			<div class="ib_m_box">
				...
				<input type="hidden" id="gde" name="gde" value=""> <!-- 검정고시 -->				
				...
				<input type="text" id="univ_major" name="univ_major" class="txt last" placeholder="전공 및 학위 (ex. 경영학과 학사)" style="width:445px; display:none;">

				<br>
				
				<div class="con_basic" style="display:none;">
					<div class="select_down" id="div_univ_etype" style="width:290px;" title="졸업상태">
					...
					<input type="text" id="div_univ_sdate" name="univ_sdate" class="txt" placeholder="입학년월 (ex. 2019.03)" onkeyup="numCheck(this, 'int'); changeDateType(this); fn_school_s_div(this);" onblur="chkDateType(this)" maxlength="6" style="width:290px;">
					<input type="text" id="div_univ_edate" name="univ_edate" class="txt" placeholder="졸업년월 (ex. 2020.02)" onkeyup="numCheck(this, 'int'); changeDateType(this); fn_school_e_div(this);" onblur="chkDateType(this)" maxlength="6" style="width:290px;">
				...
				<button type="button" id="univ_add_minor" name="전공추가" class="add_btn on" style="display:none;">다른 전공 추가</button>
			</div>
		</div>
		<%
		End If 
