			...
			<div id="memberComp" class="memberInfo comp" style="display:block;">
				...
				<div class="inputArea">
					<div class="inp">
						...
						<input type="text" id="comp_num" class="txt placehd" name="comp_num" placeholder="사업자등록번호 ( - 없이 입력)">
					</div><!-- .inp -->
					<div class="inp">
						<label for="user_id">아이디</label>
						<input type="text" id="com_id" class="txt placehd" name="com_id" placeholder="아이디 (5~12자 영문, 숫자 입력)">
					...
					<div class="inp">
						...
						<input type="text" id="comp_nm" class="txt placehd" name="com_nm" placeholder="가입당시 채용담당자 (실명) 입력">
						<div class="rt">
							<div class="alertBox">
				...
				<div class="btnWrap">
					<a href="#addInfoComp" class="btn typeSky" onclick="onSubmit_PW('Biz');">비밀번호 재설정</a>
				</div><!-- .btnWrap -->
				...
				<div id="addInfoComp" class="addLayout" style="display: block;">
					...
					<div class="inputArea">
						<div class="inp">
							...
							<input type="password" id="new_pw1_biz" class="txt placehd" name="new_pw1" placeholder="새로운 비밀번호 입력">
						</div><!-- .inp -->
						<div class="inp">
							<label for="new_pw2">새로운 비밀번호 확인</label>
							<input type="password" id="new_pw2_biz" class="txt placehd" name="new_pw2" placeholder="새로운 비밀번호 입력 확인">
						</div><!-- .inp -->
					</div><!-- .inputArea -->
					<p class="notiArea">영문, 숫자, 특수문자를 포함한 8~32자, 연속된 문자(a,b,c / 1,2,3) 사용 불가</p><!-- .notiArea -->
					<div class="btnWrap">
						<button type="button" class="btn typeSky sizeDown" onclick="PW_Modify('Biz');">비밀번호 저장</button>
