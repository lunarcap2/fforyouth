...
response.write "txtName			: " & txtName			 & "<br>"
response.write "jumin1			: " & jumin1			 & "<br>"
response.write "juminH			: " & juminH			 & "<br>"
response.write "zipcode			: " & zipcode			 & "<br>"
response.write "addr			: " & addr				 & "<br>"
response.write "detailAddr		: " & detailAddr		 & "<br>"
response.write "chk_num			: " & chk_num			 & "<br>"
response.write "univ_kind		: " & univ_kind			 & "<br>"
response.write "univ_name		: " & univ_name			 & "<br>"
response.write "univ_major		: " & univ_major		 & "<br>"
response.write "univ_syear		: " & univ_syear		 & "<br>"
response.write "univ_smonth		: " & univ_smonth		 & "<br>"
response.write "univ_eyear		: " & univ_eyear		 & "<br>"
response.write "univ_emonth		: " & univ_emonth		 & "<br>"
response.write "univ_etype		: " & univ_etype		 & "<br>"
response.write "jc_code			: " & jc_code			 & "<br>"
response.write "exp_info		: " & exp_info			 & "<br>"
response.write "exp_month		: " & exp_month			 & "<br>"
response.write "jc_content		: " & jc_content		 & "<br>"
response.write "area			: " & area				 & "<br>"
response.write "home			: " & home				 & "<br>"
response.write "employ			: " & employ			 & "<br>"
response.write "salary			: " & salary			 & "<br>"
response.write "salary_txt		: " & salary_txt		 & "<br>"
response.write "hire_h2			: " & hire_h2			 & "<br>"
response.write "hire_info		: " & hire_info			 & "<br>"
Response.write "individual_info : " & individual_info	 & "<br>"
...
Response.write juminLen13&"<br>"&Len(juminH)
'Response.end
...
If rsltCmt = "O" Then ' 입력한 아이디로 기존 가입된 정보가 없으면 회원 가입
	...
	SpName="usp_회원가입_SUB_개인회원정보"
		...
		subparam(25)=makeParam("@주민번호뒷자리", adVarChar, adParamInput, 7, juminH)  
	
		Call execSP(DBCon, SpName, subparam, "", "")

		Dim sp_sub_rtn : sp_sub_rtn = getParamOutputValue(subparam, "@rtn")
		...
		strSql2 = "insert into 회원가입환경정보(회원아이디, 가입아이피, 가입환경) values('"&compId&"', '"&strRemoteAddr&"', '"&strUserAgent&"')"
								...
								"<tr>"&_
									...
									"<td style=""width:698px;padding:20px 0;border-collapse: inherit;background:#f0f0f0;border:1px dashed #c10e2c;text-align:center;"">"&_
										"<p style=""font-size:20px;line-height:1.8;letter-spacing: -1px;color:#000;"">"&_
											...
											"부산 온라인 일자리 박람회 회원에 가입해 주셔서 감사합니다.<br>"&_
											"부산 온라인 일자리 박람회의 다양한 채용정보를 확인하세요.<br>"&_
										"</p>"&_
												...
												"<tr>"&_
													"<td colspan=""2"" style=""padding:20px 20px 0 50px;"">"&_
														"<p style=""font-size:15px;line-height:1.5;letter-spacing:0;color:#000;text-align:left;"">"&_
															"※ 부산 온라인 일자리 박람회는 온라인으로만 채용이 진행됩니다.<br>"&_
