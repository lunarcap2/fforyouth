...
<meta name="keywords" content="<%=site_name%>, 부산 온라인 일자리박람회, 화상면접, 입사지원" />
<meta name="description" content="<%=site_name%>, 부산 온라인 일자리박람회, 화상면접, 입사지원, 희망을 전하는 취업포털 커리어 www.career.co.kr" />
		...
		<div class="pop_wrap">
			...
			<div class="pop_con">
				...
				<div class="pop_footer">
					<div class="btn_area">
						<a href="javaScript:;" id="crop" onclick="fn_test(); return false; /*fn_resume_apply();return false;*/"  class="btn sky">이력서 사진등록하기</a>
					</div>
				</div>
